...
{
	private static readonly HashSet<int> FibNumbers = new HashSet<int> { 1, 2, 3, 5, 8, 13, 21, 34, 55 };
	...
	public Fibonacci(PluginConfig GlobalConfig, MapConfig Config, IStringLocalizer Localizer)
